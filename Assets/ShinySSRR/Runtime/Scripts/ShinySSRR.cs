        ...
        class SSRPass : ScriptableRenderPass {
            ...
            static void ExecuteInternal (PassData passData) {
                ...
                if (count > 0 && useReflectionsScripts) {
                    ...
                    float reflectionsScriptsMaxDistanceSqr = settings.reflectionsScriptsMaxDistance.value * settings.reflectionsScriptsMaxDistance.value;
                    ...
                    for (int k = 0; k < count; k++) {
                        ...
                        for (int j = 0; j < rendererCount; j++) {
                            ...
                            if (reflectionsScriptsMaxDistanceSqr > 0) {
                                Vector3 goPos = ssrRenderer.renderer.transform.position;
                                if (Vector3.SqrMagnitude(goPos - camPos) > reflectionsScriptsMaxDistanceSqr) continue;
                            }
