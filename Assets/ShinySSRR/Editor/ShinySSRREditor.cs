...
namespace ShinySSRR {
    ...
    public class ShinySSRREditor : VolumeComponentEditor {
        ...
        SerializedDataParameter useReflectionsScripts, reflectionsScriptsLayerMask, reflectionsScriptsMaxDistance, skipDeferredPass;
        ...
        public override void OnEnable() {
            ...
            reflectionsScriptsMaxDistance = Unpack(o.Find(x => x.reflectionsScriptsMaxDistance));
        ...
        public override void OnInspectorGUI() {
            ...
            if (reflectionsCount > 0) {
                ...
                PropertyField(reflectionsScriptsMaxDistance, new GUIContent("Max Distance"));
