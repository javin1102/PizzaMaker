...
namespace ShinySSRR {
    ...
    public class RenderFeatureEditor : Editor {
        ...
        SerializedProperty useDeferred, enableScreenSpaceNormalsPass, customSmoothnessMetallicPass, renderPassEvent, ignorePostProcessingOption, cameraLayerMask, ignoreReflectionProbes;
        Volume shinyVolume;
